...
- [#180](https://github.com/quiltt/quiltt-sdks/pull/180) [`1ea994b`](https://github.com/quiltt/quiltt-sdks/commit/1ea994b7484edad336183cec6af0657ad301e336) Thanks [@dependabot](https://github.com/apps/dependabot)! - Bump follow-redirects
...
- 24f6df1: This introduces a new Javascript API that can be used instead of or with the DOM API, giving exposure to exit events. There are a few ways to use it:
  ...
  <head>
    ...
    <script language="JavaScript">
      Quiltt.onExitSuccess((metadata) => console.log('Global onExitSuccess', metadata.connectionId))
    </script>
  </head>
  <body>
